<div id="welcome-panel" class="welcome-panel pinhole-welcome-panel">
	<a href="#" class="welcome-panel-close" id="pinhole_welcome_box_hide">Dismiss</a>
	<div class="welcome-panel-content">
	
		<h2>Thank you for choosing Pinhole!</h2>
		...
		<div class="welcome-panel-column-container">
			...
			<div class="welcome-panel-column">
				...
				<a class="button button-primary button-hero" href="<?php echo esc_url(admin_url('themes.php?page=pinhole-importer')); ?>">Run wizard</a>
			</div>
			...
			<div class="welcome-panel-column welcome-panel-last">
				...
				<a class="button button-primary button-hero" href="https://mekshq.com/documentation/pinhole/" target="_blank">Read documentation</a>
			</div>
